...
DISCORD_COMMAND_DOCUMENTATION: dict[str, str] = {
	...
	"hasrole": "`hasrole [blocked|trusted|permitting] [user ID]`: Returns whether a user is blocked/trusted, respectively.",
	...
	"save": "`save [blocked|trusted|permitting|vectorstore] [filepath (optional)]` *(Trusted only)*: Saves the blocked list/trusted list/permitting list/corpus to the provided filepath, or their last-used filepath if none is provided.",
	"load": "`load [blocked|trusted|permitting|vectorstore] [filepath (optional)]` *(Trusted only)*: Loads the blocked list/trusted list/permitting list/corpus from the provided filepath, or their last-used filepath if none is provided.",
